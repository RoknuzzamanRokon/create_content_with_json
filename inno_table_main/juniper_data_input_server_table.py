...
# Set up logging
logging.basicConfig(
    filename="juniper_list_data_server_log.log",
    level=logging.INFO,
...
tracking_file_path = 'tracking_file.txt'
insert_data_to_inno_table_with_tracking(server_engine, metadata_server, chunk_size=10, tracking_file_path=tracking_file_path)
